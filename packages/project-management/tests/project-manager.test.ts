...
// Mock ChatManager
const mockChatManager: ChatManager = {
  ...
  describe('GIVEN a project manager with chat support', () => {
    ...
    describe('WHEN creating a project', () => {
      ...
      it('THEN should throw error if same ID is consistently generated', async () => {
        ...
        await expect(projectManager.createProject(projectName))
          .rejects
          .toThrow('Unable to generate a unique project ID after multiple attempts')
