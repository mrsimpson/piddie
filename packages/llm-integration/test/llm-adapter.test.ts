...
import { LlmStreamEvent, type LlmMessage, type LlmProviderConfig } from "../src/types";
    ...
    describe("Orchestrator", () => {
        ...
        describe("processMessage", () => {
            ...
            it("should handle errors and update message status", async () => {
                ...
                await expect(orchestrator.processMessage(message)).rejects.toThrow("Test error");
